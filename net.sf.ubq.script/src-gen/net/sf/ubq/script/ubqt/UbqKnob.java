 ...
 * <ul>
 *   <li>{@link net.sf.ubq.script.ubqt.UbqKnob#getName <em>Name</em>}</li>
 *   <li>{@link net.sf.ubq.script.ubqt.UbqKnob#getRangeDefinition <em>Range Definition</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ubq.script.ubqt.UbqtPackage#getUbqKnob()
 * @model
 * @generated
 */
public interface UbqKnob extends EObject
{
   ...
   * @see #setName(String)
   * @see net.sf.ubq.script.ubqt.UbqtPackage#getUbqKnob_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link net.sf.ubq.script.ubqt.UbqKnob#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see net.sf.ubq.script.ubqt.UbqtPackage#getUbqKnob_RangeDefinition()
  ...
  /**
   * Sets the value of the '{@link net.sf.ubq.script.ubqt.UbqKnob#getRangeDefinition <em>Range Definition</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
