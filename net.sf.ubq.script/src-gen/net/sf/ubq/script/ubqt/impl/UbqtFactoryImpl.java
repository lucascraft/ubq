...
import net.sf.ubq.script.ubqt.UBQ_EVENTS;
import net.sf.ubq.script.ubqt.UBQ_GESTURES;
...
public class UbqtFactoryImpl extends EFactoryImpl implements UbqtFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case UbqtPackage.ORCHESTROR_IMPORT: return createOrchestrorImport();
      case UbqtPackage.NET_CONF_IMPORT: return createNetConfImport();
   ...
   * @generated
   */
  public OrchestrorImport createOrchestrorImport()
  {
    OrchestrorImportImpl orchestrorImport = new OrchestrorImportImpl();
    return orchestrorImport;
  }
   ...
   * @generated
   */
  public NetConfImport createNetConfImport()
  {
    NetConfImportImpl netConfImport = new NetConfImportImpl();
    return netConfImport;
  }
