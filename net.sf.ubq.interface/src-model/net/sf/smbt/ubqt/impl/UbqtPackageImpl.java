...
import net.sf.smbt.ubqt.UbqButton;
import net.sf.smbt.ubqt.UbqCheckbox;
...
import net.sf.smbt.ubqt.UbqHsbColor;
import net.sf.smbt.ubqt.UbqImage;
import net.sf.smbt.ubqt.UbqIncrementableRange;
import net.sf.smbt.ubqt.UbqKnob;
import net.sf.smbt.ubqt.UbqLabel;
import net.sf.smbt.ubqt.UbqLayout;
import net.sf.smbt.ubqt.UbqMenu;
...
import net.sf.smbt.ubqt.UbqSpinner;
import net.sf.smbt.ubqt.UbqText;
import net.sf.smbt.ubqt.UbqVuMeter;
import net.sf.smbt.ubqt.UbqWidget;
import net.sf.smbt.ubqt.UbqWidgetStyle;
...
public class UbqtPackageImpl extends EPackageImpl implements UbqtPackage {
	 ...
	 * @generated
	 */
	private EEnum proximA_STYLEEEnum = null;
	 ...
	 * @generated
	 */
	private EEnum proximA_ROLEEEnum = null;
	 ...
	 * @generated
	 */
	private EEnum proximA_FUNCTIONEEnum = null;
	 ...
	 * @see net.sf.smbt.ubqt.UbqtPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getUbqSession_Colors() {
	 ...
	 * @generated
	 */
	public EReference getUbqSession_Addresses() {
	 ...
	 * @generated
	 */
	public EReference getUbqDisplayMode_BgColor() {
		return (EReference)ubqDisplayModeEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getUbqProxima_Radius() {
		return (EAttribute)ubqProximaEClass.getEStructuralFeatures().get(4);
	}
	...
	public EReference getUbqProxima_RequiredProximi() {
		return (EReference)ubqProximaEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 * @generated
	 */
	public EReference getUbqProxima_BgColor() {
	 ...
	 * @generated
	 */
	public EReference getUbqProxima_FgColor() {
		return (EReference)ubqProximaEClass.getEStructuralFeatures().get(12);
	}
	 ...
	 * @generated
	 */
	public EAttribute getUbqProxima_Limit() {
		return (EAttribute)ubqProximaEClass.getEStructuralFeatures().get(13);
	}
	 ...
	 * @generated
	 */
	public EAttribute getUbqProxima_Step() {
		return (EAttribute)ubqProximaEClass.getEStructuralFeatures().get(14);
	}
	 ...
	 * @generated
	 */
	public EAttribute getUbqProxima_Speed() {
		return (EAttribute)ubqProximaEClass.getEStructuralFeatures().get(15);
	}
	 ...
	 * @generated
	 */
	public EAttribute getUbqProxima_Style() {
		return (EAttribute)ubqProximaEClass.getEStructuralFeatures().get(16);
	}
	 ...
	 * @generated
	 */
	public EAttribute getUbqProxima_Rebang() {
		return (EAttribute)ubqProximaEClass.getEStructuralFeatures().get(17);
	}
	 ...
	 * @generated
	 */
	public EAttribute getUbqProxima_Role() {
		return (EAttribute)ubqProximaEClass.getEStructuralFeatures().get(18);
	}
	 ...
	 * @generated
	 */
	public EAttribute getUbqProxima_Function() {
		return (EAttribute)ubqProximaEClass.getEStructuralFeatures().get(19);
	}
	 ...
	 * @generated
	 */
	public EAttribute getUbqProxima_Id() {
		return (EAttribute)ubqProximaEClass.getEStructuralFeatures().get(20);
	}
	 ...
	 * @generated
	 */
	public EAttribute getUbqColor_R() {
		return (EAttribute)ubqColorEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getUbqColor_G() {
		return (EAttribute)ubqColorEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getUbqColor_B() {
		return (EAttribute)ubqColorEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EEnum getPROXIMA_STYLE() {
		return proximA_STYLEEEnum;
	}
	 ...
	 * @generated
	 */
	public EEnum getPROXIMA_ROLE() {
		return proximA_ROLEEEnum;
	}
	 ...
	 * @generated
	 */
	public EEnum getPROXIMA_FUNCTION() {
		return proximA_FUNCTIONEEnum;
	}
	...
	public void createPackageContents() {
		...
		createEReference(ubqSessionEClass, UBQ_SESSION__COLORS);
		createEReference(ubqSessionEClass, UBQ_SESSION__ADDRESSES);

		ubqDisplayModeEClass = createEClass(UBQ_DISPLAY_MODE);
		createEReference(ubqDisplayModeEClass, UBQ_DISPLAY_MODE__MODE);
		createEReference(ubqDisplayModeEClass, UBQ_DISPLAY_MODE__BG_COLOR);
		...
		createEReference(ubqProximaEClass, UBQ_PROXIMA__BG_COLOR);
		createEReference(ubqProximaEClass, UBQ_PROXIMA__FG_COLOR);
		createEAttribute(ubqProximaEClass, UBQ_PROXIMA__LIMIT);
		createEAttribute(ubqProximaEClass, UBQ_PROXIMA__STEP);
		createEAttribute(ubqProximaEClass, UBQ_PROXIMA__SPEED);
		createEAttribute(ubqProximaEClass, UBQ_PROXIMA__STYLE);
		createEAttribute(ubqProximaEClass, UBQ_PROXIMA__REBANG);
		createEAttribute(ubqProximaEClass, UBQ_PROXIMA__ROLE);
		createEAttribute(ubqProximaEClass, UBQ_PROXIMA__FUNCTION);
		createEAttribute(ubqProximaEClass, UBQ_PROXIMA__ID);
		...
		createEAttribute(ubqColorEClass, UBQ_COLOR__R);
		createEAttribute(ubqColorEClass, UBQ_COLOR__G);
		createEAttribute(ubqColorEClass, UBQ_COLOR__B);
		...
		proximA_STYLEEEnum = createEEnum(PROXIMA_STYLE);
		proximA_ROLEEEnum = createEEnum(PROXIMA_ROLE);
		proximA_FUNCTIONEEnum = createEEnum(PROXIMA_FUNCTION);
	}
	...
	public void initializePackageContents() {
		...
		ubqSessionEClass.getESuperTypes().add(theEnginePackage.getIConnectedUnit());
		...
		initEReference(getUbqSession_Colors(), this.getUbqColor(), null, "colors", null, 0, -1, UbqSession.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUbqSession_Addresses(), theXcpPackage.getXCPAddress(), null, "addresses", null, 0, 1, UbqSession.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getUbqDisplayMode_BgColor(), this.getUbqColor(), null, "bgColor", null, 0, 1, UbqDisplayMode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getUbqProxima_Angle(), ecorePackage.getEFloat(), "angle", null, 0, 1, UbqProxima.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getUbqProxima_BgColor(), this.getUbqColor(), null, "bgColor", null, 0, 1, UbqProxima.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUbqProxima_FgColor(), this.getUbqColor(), null, "fgColor", null, 0, 1, UbqProxima.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUbqProxima_Limit(), ecorePackage.getEInt(), "limit", null, 0, 1, UbqProxima.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUbqProxima_Step(), ecorePackage.getEDouble(), "step", null, 0, 1, UbqProxima.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUbqProxima_Speed(), ecorePackage.getEDouble(), "speed", null, 0, 1, UbqProxima.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUbqProxima_Style(), this.getPROXIMA_STYLE(), "style", null, 0, 1, UbqProxima.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUbqProxima_Rebang(), theEcorePackage.getEInt(), "rebang", null, 0, 1, UbqProxima.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUbqProxima_Role(), this.getPROXIMA_ROLE(), "role", null, 0, 1, UbqProxima.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUbqProxima_Function(), this.getPROXIMA_FUNCTION(), "function", null, 0, 1, UbqProxima.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUbqProxima_Id(), theEcorePackage.getEInt(), "id", null, 0, 1, UbqProxima.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getUbqColor_R(), ecorePackage.getEInt(), "r", null, 0, 1, UbqColor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUbqColor_G(), ecorePackage.getEInt(), "g", null, 0, 1, UbqColor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUbqColor_B(), ecorePackage.getEInt(), "b", null, 0, 1, UbqColor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(sloT_STATUSEEnum, net.sf.smbt.ubqt.SLOT_STATUS.class, "SLOT_STATUS");
		addEEnumLiteral(sloT_STATUSEEnum, net.sf.smbt.ubqt.SLOT_STATUS.SELECTED);
		addEEnumLiteral(sloT_STATUSEEnum, net.sf.smbt.ubqt.SLOT_STATUS.UNSELECTED);

		initEEnum(sloT_KINDEEnum, net.sf.smbt.ubqt.SLOT_KIND.class, "SLOT_KIND");
		addEEnumLiteral(sloT_KINDEEnum, net.sf.smbt.ubqt.SLOT_KIND.PUSH);

		initEEnum(proximA_STATUSEEnum, net.sf.smbt.ubqt.PROXIMA_STATUS.class, "PROXIMA_STATUS");
		addEEnumLiteral(proximA_STATUSEEnum, net.sf.smbt.ubqt.PROXIMA_STATUS.DEACTIVATED);
		addEEnumLiteral(proximA_STATUSEEnum, net.sf.smbt.ubqt.PROXIMA_STATUS.ACTIVATED);
		addEEnumLiteral(proximA_STATUSEEnum, net.sf.smbt.ubqt.PROXIMA_STATUS.DISABLED);

		initEEnum(slotsEEnum, net.sf.smbt.ubqt.SLOTS.class, "SLOTS");
		addEEnumLiteral(slotsEEnum, net.sf.smbt.ubqt.SLOTS.P0);
		addEEnumLiteral(slotsEEnum, net.sf.smbt.ubqt.SLOTS.P23);
		addEEnumLiteral(slotsEEnum, net.sf.smbt.ubqt.SLOTS.P45);
		addEEnumLiteral(slotsEEnum, net.sf.smbt.ubqt.SLOTS.P67);
		addEEnumLiteral(slotsEEnum, net.sf.smbt.ubqt.SLOTS.P90);
		addEEnumLiteral(slotsEEnum, net.sf.smbt.ubqt.SLOTS.P113);
		addEEnumLiteral(slotsEEnum, net.sf.smbt.ubqt.SLOTS.P135);
		addEEnumLiteral(slotsEEnum, net.sf.smbt.ubqt.SLOTS.P157);
		addEEnumLiteral(slotsEEnum, net.sf.smbt.ubqt.SLOTS.P180);
		addEEnumLiteral(slotsEEnum, net.sf.smbt.ubqt.SLOTS.P203);
		addEEnumLiteral(slotsEEnum, net.sf.smbt.ubqt.SLOTS.P225);
		addEEnumLiteral(slotsEEnum, net.sf.smbt.ubqt.SLOTS.P247);
		addEEnumLiteral(slotsEEnum, net.sf.smbt.ubqt.SLOTS.P270);
		addEEnumLiteral(slotsEEnum, net.sf.smbt.ubqt.SLOTS.P293);
		addEEnumLiteral(slotsEEnum, net.sf.smbt.ubqt.SLOTS.P315);
		addEEnumLiteral(slotsEEnum, net.sf.smbt.ubqt.SLOTS.P337);

		initEEnum(ubQ_LAYOUT_KINDEEnum, net.sf.smbt.ubqt.UBQ_LAYOUT_KIND.class, "UBQ_LAYOUT_KIND");
		addEEnumLiteral(ubQ_LAYOUT_KINDEEnum, net.sf.smbt.ubqt.UBQ_LAYOUT_KIND.UBQ_ROW_LAYOUT);
		addEEnumLiteral(ubQ_LAYOUT_KINDEEnum, net.sf.smbt.ubqt.UBQ_LAYOUT_KIND.UBQ_FILL_LAYOUT);

		initEEnum(ubQ_EVENTSEEnum, net.sf.smbt.ubqt.UBQ_EVENTS.class, "UBQ_EVENTS");
		addEEnumLiteral(ubQ_EVENTSEEnum, net.sf.smbt.ubqt.UBQ_EVENTS.PROXIMA_ADD);
		addEEnumLiteral(ubQ_EVENTSEEnum, net.sf.smbt.ubqt.UBQ_EVENTS.PROXIMA_REMOVE);
		addEEnumLiteral(ubQ_EVENTSEEnum, net.sf.smbt.ubqt.UBQ_EVENTS.PROXIMA_UPDATE);
		addEEnumLiteral(ubQ_EVENTSEEnum, net.sf.smbt.ubqt.UBQ_EVENTS.CURSOR_ADD);
		addEEnumLiteral(ubQ_EVENTSEEnum, net.sf.smbt.ubqt.UBQ_EVENTS.CURSOR_REMOVE);
		addEEnumLiteral(ubQ_EVENTSEEnum, net.sf.smbt.ubqt.UBQ_EVENTS.CURSOR_UPDATE);
		addEEnumLiteral(ubQ_EVENTSEEnum, net.sf.smbt.ubqt.UBQ_EVENTS.WIDGET_SELECTION);
		addEEnumLiteral(ubQ_EVENTSEEnum, net.sf.smbt.ubqt.UBQ_EVENTS.WIDGET_DOWN);
		addEEnumLiteral(ubQ_EVENTSEEnum, net.sf.smbt.ubqt.UBQ_EVENTS.WIDGET_UP);
		addEEnumLiteral(ubQ_EVENTSEEnum, net.sf.smbt.ubqt.UBQ_EVENTS.WIDGET_DRAG);
		addEEnumLiteral(ubQ_EVENTSEEnum, net.sf.smbt.ubqt.UBQ_EVENTS.WIDGET_ENTER);
		addEEnumLiteral(ubQ_EVENTSEEnum, net.sf.smbt.ubqt.UBQ_EVENTS.WIDGET_LEAVE);
		addEEnumLiteral(ubQ_EVENTSEEnum, net.sf.smbt.ubqt.UBQ_EVENTS.WIDGET_HOVER);
		addEEnumLiteral(ubQ_EVENTSEEnum, net.sf.smbt.ubqt.UBQ_EVENTS.INPUT_CMD_ADD);

		initEEnum(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.class, "UBQ_GESTURES");
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.ONE_SINGLE_TAP);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.ONE_DOUBLE_TAP);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.ONE_TRIPLE_TAP);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.TWO_SINGLE_TAP);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.TWO_DOUBLE_TAP);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.TWO_TRIPLE_TAP);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.ONE_HOLD);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.TWO_HOLD);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.THREE_HOLD);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.ONE_DRAG);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.TWO_DRAG);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.THREE_DRAG);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.ONE_HOLD_ONE_DRAG);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.ONE_HOLD_TWO_DRAG);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.TWO_HOLD_ONE_DRAG);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.ONE_HOLD_ONE_SINGLE_TAP);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.ONE_HOLD_TWO_SINGLE_TAP);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.ONE_HOLD_ONE_DOUBLE_TAP);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.ONE_HOLD_TWO_DOUBLE_TAP);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.ONE_HOLD_ONE_TRIPLE_TAP);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.ONE_HOLD_TWO_TRIPLE_TAP);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.VALID);
		addEEnumLiteral(ubQ_GESTURESEEnum, net.sf.smbt.ubqt.UBQ_GESTURES.DISCARDED);

		initEEnum(fonT_STYLEEEnum, net.sf.smbt.ubqt.FONT_STYLE.class, "FONT_STYLE");
		addEEnumLiteral(fonT_STYLEEEnum, net.sf.smbt.ubqt.FONT_STYLE.BOLD);
		addEEnumLiteral(fonT_STYLEEEnum, net.sf.smbt.ubqt.FONT_STYLE.ITALIC);
		addEEnumLiteral(fonT_STYLEEEnum, net.sf.smbt.ubqt.FONT_STYLE.STRIKED);
		addEEnumLiteral(fonT_STYLEEEnum, net.sf.smbt.ubqt.FONT_STYLE.NORMAL);

		initEEnum(bordeR_STYLEEEnum, net.sf.smbt.ubqt.BORDER_STYLE.class, "BORDER_STYLE");
		addEEnumLiteral(bordeR_STYLEEEnum, net.sf.smbt.ubqt.BORDER_STYLE.DASHED);
		addEEnumLiteral(bordeR_STYLEEEnum, net.sf.smbt.ubqt.BORDER_STYLE.NORMAL);

		initEEnum(proximA_STYLEEEnum, net.sf.smbt.ubqt.PROXIMA_STYLE.class, "PROXIMA_STYLE");
		addEEnumLiteral(proximA_STYLEEEnum, net.sf.smbt.ubqt.PROXIMA_STYLE.DISC);
		addEEnumLiteral(proximA_STYLEEEnum, net.sf.smbt.ubqt.PROXIMA_STYLE.SQUARE);
		addEEnumLiteral(proximA_STYLEEEnum, net.sf.smbt.ubqt.PROXIMA_STYLE.HEXAGON);
		addEEnumLiteral(proximA_STYLEEEnum, net.sf.smbt.ubqt.PROXIMA_STYLE.OCTOSTAR);
		addEEnumLiteral(proximA_STYLEEEnum, net.sf.smbt.ubqt.PROXIMA_STYLE.HEXASTAR);
		addEEnumLiteral(proximA_STYLEEEnum, net.sf.smbt.ubqt.PROXIMA_STYLE.OCTOGON);

		initEEnum(proximA_ROLEEEnum, net.sf.smbt.ubqt.PROXIMA_ROLE.class, "PROXIMA_ROLE");
		addEEnumLiteral(proximA_ROLEEEnum, net.sf.smbt.ubqt.PROXIMA_ROLE.SIN_OSC);
		addEEnumLiteral(proximA_ROLEEEnum, net.sf.smbt.ubqt.PROXIMA_ROLE.SQR_OSC);
		addEEnumLiteral(proximA_ROLEEEnum, net.sf.smbt.ubqt.PROXIMA_ROLE.TRI_OSC);
		addEEnumLiteral(proximA_ROLEEEnum, net.sf.smbt.ubqt.PROXIMA_ROLE.SAW_OSC);
		addEEnumLiteral(proximA_ROLEEEnum, net.sf.smbt.ubqt.PROXIMA_ROLE.SAMPLER);
		addEEnumLiteral(proximA_ROLEEEnum, net.sf.smbt.ubqt.PROXIMA_ROLE.SEQUENCER);
		addEEnumLiteral(proximA_ROLEEEnum, net.sf.smbt.ubqt.PROXIMA_ROLE.TEMPO);
		addEEnumLiteral(proximA_ROLEEEnum, net.sf.smbt.ubqt.PROXIMA_ROLE.PHASOR);
		addEEnumLiteral(proximA_ROLEEEnum, net.sf.smbt.ubqt.PROXIMA_ROLE.NONE);

		initEEnum(proximA_FUNCTIONEEnum, net.sf.smbt.ubqt.PROXIMA_FUNCTION.class, "PROXIMA_FUNCTION");
		addEEnumLiteral(proximA_FUNCTIONEEnum, net.sf.smbt.ubqt.PROXIMA_FUNCTION.KNOB);
		addEEnumLiteral(proximA_FUNCTIONEEnum, net.sf.smbt.ubqt.PROXIMA_FUNCTION.GATE);
		addEEnumLiteral(proximA_FUNCTIONEEnum, net.sf.smbt.ubqt.PROXIMA_FUNCTION.SWITCH);
		addEEnumLiteral(proximA_FUNCTIONEEnum, net.sf.smbt.ubqt.PROXIMA_FUNCTION.TOGGLE);
		addEEnumLiteral(proximA_FUNCTIONEEnum, net.sf.smbt.ubqt.PROXIMA_FUNCTION.NONE);
