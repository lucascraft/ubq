...
import net.sf.ubq.utils.fmurf.LaunchUtils;
...
public class LaunchUbiquisenseFmurfApp extends Action implements IEditorActionDelegate{
	private UbqSession seesion;
	
	public LaunchUbiquisenseFmurfApp() {
	...
	public void run(IAction action) {
		String settings = TangibleGuiUtuils.INSTANCE.refreshSettingsXMLAndRunFMURF(seesion);		
		LaunchUtils.updateFmurfSettings(settings);
		LaunchUtils.launch("FMURF");
	}
