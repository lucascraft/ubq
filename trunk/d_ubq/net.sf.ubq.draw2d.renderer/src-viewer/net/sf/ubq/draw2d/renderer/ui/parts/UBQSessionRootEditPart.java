...
import net.sf.ubq.draw2d.renderer.ui.figures.UbqUILayer;

import org.eclipse.draw2d.LayeredPane;
import org.eclipse.gef.editparts.ScalableFreeformRootEditPart;

public class UBQSessionRootEditPart extends ScalableFreeformRootEditPart {
	
	@Override
	protected LayeredPane createPrintableLayers() {
		LayeredPane layeredPane = super.createPrintableLayers();
		
		layeredPane.add(new UbqUILayer());
