 ...
 * <ul>
 *   <li>{@link net.sf.ubq.script.ubqt.UbqBorderStyle#getTickness <em>Tickness</em>}</li>
 *   <li>{@link net.sf.ubq.script.ubqt.UbqBorderStyle#getStyles <em>Styles</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.ubq.script.ubqt.UbqtPackage#getUbqBorderStyle()
 * @model
 * @generated
 */
public interface UbqBorderStyle extends EObject
{
   ...
   * @see #setTickness(int)
   * @see net.sf.ubq.script.ubqt.UbqtPackage#getUbqBorderStyle_Tickness()
   * @model
   * @generated
   */
  int getTickness();
  ...
  /**
   * Sets the value of the '{@link net.sf.ubq.script.ubqt.UbqBorderStyle#getTickness <em>Tickness</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link net.sf.ubq.script.ubqt.BORDER_STYLE}.
   * The literals are from the enumeration {@link net.sf.ubq.script.ubqt.BORDER_STYLE}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see net.sf.ubq.script.ubqt.UbqtPackage#getUbqBorderStyle_Styles()
   * @model unique="false"
   * @generated
   */
