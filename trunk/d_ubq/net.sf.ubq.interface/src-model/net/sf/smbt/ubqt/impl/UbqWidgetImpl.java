 ...
 * <ul>
 *   <li>{@link net.sf.smbt.ubqt.impl.UbqWidgetImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link net.sf.smbt.ubqt.impl.UbqWidgetImpl#getBounds <em>Bounds</em>}</li>
 *   <li>{@link net.sf.smbt.ubqt.impl.UbqWidgetImpl#getAngle <em>Angle</em>}</li>
 *   <li>{@link net.sf.smbt.ubqt.impl.UbqWidgetImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link net.sf.smbt.ubqt.impl.UbqWidgetImpl#getEmitted <em>Emitted</em>}</li>
 *   <li>{@link net.sf.smbt.ubqt.impl.UbqWidgetImpl#getReacted <em>Reacted</em>}</li>
 *   <li>{@link net.sf.smbt.ubqt.impl.UbqWidgetImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UbqWidgetImpl extends MinimalEObjectImpl.Container implements UbqWidget {
		...
		if (parent != null && parent.eIsProxy()) {
			...
			if (parent != oldParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UbqtPackage.UBQ_WIDGET__PARENT, oldParent, parent));
			}
		}
		return parent;
	}
	...
	public void setParent(UbqComposite newParent) {
		...
		parent = newParent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UbqtPackage.UBQ_WIDGET__PARENT, oldParent, parent));
	}
	...
	public void setBounds(UbqBounds newBounds) {
		if (newBounds != bounds) {
			...
			if (bounds != null)
				msgs = ((InternalEObject)bounds).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UbqtPackage.UBQ_WIDGET__BOUNDS, null, msgs);
			if (newBounds != null)
				msgs = ((InternalEObject)newBounds).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UbqtPackage.UBQ_WIDGET__BOUNDS, null, msgs);
			msgs = basicSetBounds(newBounds, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UbqtPackage.UBQ_WIDGET__BOUNDS, newBounds, newBounds));
	}
	...
	public void setAngle(int newAngle) {
		...
		angle = newAngle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UbqtPackage.UBQ_WIDGET__ANGLE, oldAngle, angle));
	}
	...
	public void setStyle(UbqWidgetStyle newStyle) {
		if (newStyle != style) {
			NotificationChain msgs = null;
			if (style != null)
				msgs = ((InternalEObject)style).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UbqtPackage.UBQ_WIDGET__STYLE, null, msgs);
			if (newStyle != null)
				msgs = ((InternalEObject)newStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UbqtPackage.UBQ_WIDGET__STYLE, null, msgs);
			msgs = basicSetStyle(newStyle, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UbqtPackage.UBQ_WIDGET__STYLE, newStyle, newStyle));
	}
	...
	public void setReacted(UbqHandledReactions newReacted) {
		if (newReacted != reacted) {
			NotificationChain msgs = null;
			if (reacted != null)
				msgs = ((InternalEObject)reacted).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UbqtPackage.UBQ_WIDGET__REACTED, null, msgs);
			if (newReacted != null)
				msgs = ((InternalEObject)newReacted).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UbqtPackage.UBQ_WIDGET__REACTED, null, msgs);
			msgs = basicSetReacted(newReacted, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UbqtPackage.UBQ_WIDGET__REACTED, newReacted, newReacted));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UbqtPackage.UBQ_WIDGET__NAME, oldName, name));
	}
