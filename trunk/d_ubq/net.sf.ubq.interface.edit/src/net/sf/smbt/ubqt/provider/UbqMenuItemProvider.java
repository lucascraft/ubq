...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.ubqt.UbqMenu} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UbqMenuItemProvider
	 ...
	 * @generated
	 */
	public UbqMenuItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UbqMenu_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UbqMenu_name_feature", "_UI_UbqMenu_type"),
				 UbqtPackage.Literals.UBQ_MENU__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UbqtPackage.Literals.UBQ_MENU__CHILDREN);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UbqMenu"));
	}
	...
	public String getText(Object object) {
		String label = ((UbqMenu)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UbqMenu_type") :
			getString("_UI_UbqMenu_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UbqMenu.class)) {
			case UbqtPackage.UBQ_MENU__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case UbqtPackage.UBQ_MENU__CHILDREN:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UbqtPackage.Literals.UBQ_MENU__CHILDREN,
