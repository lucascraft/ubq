...
public class ProximaRangeMaxPropertySection extends
	...
	protected Integer getFeatureInteger() {
		return new Integer(((UbqIncrementableRange)getEObject()).getMax());
	}

	@Override
	protected EStructuralFeature getFeature() {
		return UbqtPackage.Literals.UBQ_INCREMENTABLE_RANGE__MAX;
	}
