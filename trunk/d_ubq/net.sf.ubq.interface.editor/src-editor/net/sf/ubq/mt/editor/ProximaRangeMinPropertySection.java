...
public class ProximaRangeMinPropertySection extends
	...
	protected Integer getFeatureInteger() {
		return new Integer(((UbqIncrementableRange)getEObject()).getMin());
	}

	@Override
	protected EStructuralFeature getFeature() {
		return UbqtPackage.Literals.UBQ_INCREMENTABLE_RANGE__MIN;
	}
